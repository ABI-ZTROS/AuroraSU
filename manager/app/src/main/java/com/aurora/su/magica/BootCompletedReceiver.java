package com.aurora.su.magica;

import static com.aurora.su.magica.AppZygotePreload.TAG;
...
import com.aurora.su.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.aurora.su.magica.LAUNCH".equals(action)) {
            return;
        }
