package com.aurora.su.ui.kernelFlash.util

import android.content.Context
import android.util.Log
import com.aurora.su.ui.util.getRootShell
...
class RemoteToolsDownloader(
    ...
    companion object {
        ...
        // 远程下载URL配置
        private const val KPTOOLS_REMOTE_URL = "https://raw.githubusercontent.com/ShirkNeko/AuroraSU_patch/refs/heads/main/kpm/kptools"
        private const val KPIMG_REMOTE_URL = "https://raw.githubusercontent.com/ShirkNeko/AuroraSU_patch/refs/heads/main/kpm/kpimg"
    ...
    private suspend fun downloadFromRemote(
        ...
        try {
            connection = (URL(remoteUrl).openConnection() as HttpURLConnection).apply {
                ...
                requestMethod = "GET"
                setRequestProperty("User-Agent", "AuroraSU-KPM-Downloader/1.0")
